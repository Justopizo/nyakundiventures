...
<h1 class="page-title"><i class="fas fa-building"></i> Houses for Sale</h1>
                ...
                <div class="property-card">
                    ...
                    <div class="property-content">
                        ...
                        <div class="property-details">
                            <p class="price"><i class="fas fa-money-bill"></i> KSH <?php echo number_format($house['price']); ?></p>
                        ...
                        <div class="property-actions">
                            <button class="btn btn-primary" onclick="openBuyModal(<?php echo $house['id']; ?>, '<?php echo htmlspecialchars($house['title']); ?>', <?php echo $house['price']; ?>)">
...
<style>
/* Reuse styles from rental_houses.php */
.alert {
    padding: 15px;
    margin-bottom: 20px;
    border-radius: 8px;
...
function viewDetails(houseId) {
    alert('Property details would be displayed here. This feature can be enhanced with a detailed modal or separate page.');
}
